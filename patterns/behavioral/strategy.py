...
Реализация включает 3 сущности: клиент, контекст, стратегии (1 и более).
Клиент взаимодействует с контекстом, контекст передаёт исполнение какой-то логики выбранной стратегии
